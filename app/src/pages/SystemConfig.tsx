...
const options: Array<{ value: GatewayKind; title: string; desc: string; defaultUrl: string }> = [
  {
    ...
    desc: 'The built-in live backend: WhatsApp engine + AI auto-responder + real-time WebSocket events.',
    ...
    <div className="p-4 sm:p-6 space-y-6 max-w-3xl">
      <div>
        ...
        <p className="text-muted-foreground">
          Backend connection and gateway settings. Superadmin only — not visible to tenants.
        </p>
      </div>
